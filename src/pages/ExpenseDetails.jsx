...
// Este componente muestra los detalles de un gasto y permite editar o borrar el gasto
    ...
    <div style={{ paddingTop: "100px" }}>
      <Card className="max-w-[400px] mb-2">
        <CardHeader className="flex justify-between">
          ...
          <Chip color="success" variant="shadow" className="text-3xl font-bold">
            {oneExpense.amount.toFixed(2)} €
          </Chip>
        </CardHeader>
        <Divider />
        <CardBody
        ...
        <CardFooter className="flex justify-between">
          <div>
            <p className="text-small text-default-500">
              {moment(oneExpense.date).format("lll")}
            </p>
          </div>
      ...
      <Button
        ...
        size="sm"
        variant="bordered"
        onClick={() => navigate("/account/expenses")}
      >
        <svg
          width="20"
          height="20"
